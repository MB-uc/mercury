...
5. **Connect.IQ benchmark context** — Table comparing company scores (actual or estimated) against index medians and percentiles. 1 paragraph of interpretation below.
...
7. **Connect.IQ benchmark context** — Side-by-side IQ scores for both companies. Table columns: Metric, Company A, Company B, Difference. Include index, overall score, rank, and 6-8 category scores. 1 paragraph of interpretation.
...
2. **Executive summary** — 3-4 paragraphs with overall IQ placement and key themes
...
6. **Connect.IQ benchmark context** — Full benchmark table
