...
10. **Compliance self-check** — run checks A–H; repair failures
...
**Step 3 — Situational awareness (web_search):** Recent news (6 months): leadership, M&A,
results, ESG, controversies. Each event must have: date, source, relevance to website. Financial
calendar: upcoming dates. Rules: no share price, no analyst opinion, no inferred sentiment.
...
**Step 10 — Compliance self-check.** Run checks A–H.
